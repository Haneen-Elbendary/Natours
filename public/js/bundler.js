    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Error Logged Out! Try again.');
        case 10:
        case "end":
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (result.data.status === 'success') {
            ...
            window.setTimeout(function () {
              location.assign('/verify-email-code'); // Redirect after successful signup
            }, 1500);
          }
          _context.next = 10;
          break;
...
},{"./alerts":"alerts.js","axios":"../../node_modules/axios/index.js"}],"verifyEmail.js":[function(require,module,exports) {
"use strict";
...
var verifyEmail = exports.verifyEmail = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, verificationCode) {
    var result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          result = _context.sent;
          if (result.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Email Verified Successfully!');
            window.setTimeout(function () {
        ...
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('error', _context.t0.response.data.message || 'Verification failed');
        case 10:
        case "end":
          return _context.stop();
      }
...
var showMap = exports.showMap = function showMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGFuZWVuLWVsYmVuZGFyeSIsImEiOiJjbTZsMG51Y2IwM3h5Mm1zOHExcWlvb3FmIn0.rqiYwc6V_IJTOwtQ2cISfA';
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    var stripe, session, checkoutUrl;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _stripeJs.loadStripe)("".concat(undefined));
        case 3:
        ...
        case 6:
          ...
          // Get the session URL
          checkoutUrl = session.data.session.url; // Redirect the user to the Stripe checkout page
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","@stripe/stripe-js":"../../node_modules/@stripe/stripe-js/lib/index.mjs"}],"createReview.js":[function(require,module,exports) {
"use strict";
...
var createReview = exports.createReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(review, rating, user, tour) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'The review was added successfully!');
            setTimeout(function () {
              window.location.reload();
            }, 5000);
          }
        ...
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          if (_context.t0.response.data.message.includes('index: tour_1_user_1')) (0, _alerts.showAlert)('error', 'You can create 1 review only for each booked tour!');else (0, _alerts.showAlert)('error', _context.t0.response.data.message || 'Something went wrong');
        case 10:
        case "end":
          return _context.stop();
      }
...
var btnPassword = document.querySelector('.btn-password');
var bookBtn = document.getElementById('book-tour');
var signupForm = document.querySelector('.form--signUp');
var verifyForm = document.querySelector('.form--verify');
var reviewForm = document.querySelector('.review-form');
var submitReviewBtn = document.querySelector('#submitReview');
// Values
// Delegation
if (mapBox) {
...
if (verifyForm) {
  verifyForm.addEventListener('submit', function (e) {
    ...
    var emailVerify = document.getElementById('email-verify').value;
    (0, _verifyEmail.verifyEmail)(emailVerify, verificationCode);
  });
}
if (reviewForm) {
  reviewForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var rating, review, user, tour;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            ...
            user = submitReviewBtn.dataset.user;
            tour = submitReviewBtn.dataset.tour; // Validate inputs
            if (!(!rating || !review)) {
              _context.next = 8;
              break;
            }
            (0, _alerts.showAlert)('error', 'Please fill in all fields');
            return _context.abrupt("return");
          case 8:
            _context.next = 10;
            return (0, _createReview.createReview)(review, rating, user, tour);
          case 10:
          case "end":
            return _context.stop();
        }
